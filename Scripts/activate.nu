...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Vivek\PycharmProjects\Appointment Django'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Vivek\PycharmProjects\Appointment Django\Scripts\deactivate.nu'
